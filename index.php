...
include 'chatbot/chat_implement.php';
if (isset($_GET['newfp'])) {
...
elseif (isset($_GET['signup'])) {
    showPage('header', ['page_title' => 'Feedback - Sign up']);
    showPage('signup');
}elseif (isset($_GET['enquiry'])) {
    showPage('header', ['page_title' => 'Feedback - Enquiry']);
    showPage('blocked_user_enquiry_form');
} elseif (isset($_GET['login'])) {

    showPage('header', ['page_title' => 'Feedback - Login']);
    showPage('login');
} elseif (isset($_GET['forgotpassword'])) {

    showPage('header', ['page_title' => 'Feedback - Forgot Password']);
    showPage('forgot_password');
} 
elseif (isset($_GET['submitfeedback'])) {
    // Show the page for submitting feedback
    showPage('header', ['page_title' => 'Submit Feedback']);
    showPage('navbar');
    showPage('submit_feedback');  // Assuming you have a file called submit_feedback.php
}
else {
