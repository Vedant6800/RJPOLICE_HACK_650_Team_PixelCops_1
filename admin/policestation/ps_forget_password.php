...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "SELECT * FROM police_station WHERE station_code = '$stationCode' AND verification_code = '$verificationCode'";
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-5">
                                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                                            ...
                                            <div class="card-body">
                                                <form action="password.php?stcode='.$stationCode.'" method="post">
                                                    <div class="mb-3">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header justify-content-center text-center d-flex"> <img class="mb-4" src="../../assets/images/Rajasthan-Police-RAJ-Police.webp" alt="" height="50"></div>
                                <div class="card-body">
                                    <form action="ps_forget_password.php" method="post">
                                        <div class="mb-3">
                                            <label for="stationCode" class="form-label">Station Code</label>
                                            <input type="text" class="form-control" id="stationCode" name="stationCode" placeholder="Enter Station Code" required>
                                        </div>
