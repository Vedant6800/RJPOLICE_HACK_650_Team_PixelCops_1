...
<div class="container col-md-9 col-sm-11 rounded-0">
    <div class="col-12 rounded p-4 mt-4 d-md-flex gap-5 bg-white">
    ...
    <div class="gallery d-flex flex-wrap gap-2 mb-4">
        ...
        ?>
            <img src="assets/images/posts/<?= $post['post_img'] ?>" data-bs-toggle="modal" data-bs-target="#postview<?= $post['id'] ?>" width="32%" height="auto" class="rounded" />
